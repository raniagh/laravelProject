...
<!-- Mirrored from thevectorlab.net/flatlab/basic_table.blade.php by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Mar 2017 22:46:46 GMT -->
<head>
    <meta charset="utf-8">
              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li><a href="login.blade.php"><i class="fa fa-key"></i> Log Out</a></li>
                      </ul>
                  </li>
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a  href="basic_table.blade.php">Basic Table</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="project_list.blade.php">Project List</a></li>
