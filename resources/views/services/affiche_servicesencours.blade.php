                                ...
                                <ul id="sortable" class="task-list">
                                    ...
                                    <li class="list-primary">
                                        ...
                                        <div class="task-title">
                                           ...
                                           <a href="{{ route('services.supprimer', $service->id_service) }}" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" rel="tooltip" title="Refuser la demande"></i> Refuser demande </a> </div>
                                        </div>
                                    </li><br/>
                                        @elseif($days==0)
